...
var O = (o, r) => b(o, "name", { value: r, configurable: !0 });
import { LRLanguage as t, indentNodeProp as P, delimitedIndent as s, foldNodeProp as a, foldInside as n, styleTags as S, LanguageSupport as Q, LRParser as i, tags as e } from "../../../editor.js";
const p = { __proto__: null, anyref: 34, dataref: 34, eqref: 34, externref: 34, i31ref: 34, funcref: 34, i8: 34, i16: 34, i32: 34, i64: 34, f32: 34, f64: 34 }, d = /* @__PURE__ */ i.deserialize({
  version: 14,
  ...
  tokenizers: [0],
  topRules: { Module: [0, 3] },
  specialized: [{ term: 9, get: /* @__PURE__ */ O((o) => p[o] || -1, "get") }],
  tokenPrec: 0
}), l = /* @__PURE__ */ t.define({
  name: "wast",
