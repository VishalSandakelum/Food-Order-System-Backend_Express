...
var $ = (Q, P) => e(Q, "name", { value: P, configurable: !0 });
import { styleTags as s, tags as O, LRParser as X, LRLanguage as l, indentNodeProp as Y, continuedIndent as i, flatIndent as S, delimitedIndent as o, foldNodeProp as t, foldInside as Z, LanguageSupport as n } from "../../../editor.js";
const _ = s({
  null: O.null,
  ...
  ".": O.derefOperator,
  ", ;": O.separator
}), R = { __proto__: null, true: 34, false: 34, null: 42, void: 46, byte: 48, short: 48, int: 48, long: 48, char: 48, float: 48, double: 48, boolean: 48, extends: 62, super: 64, class: 76, this: 78, new: 84, public: 100, protected: 102, private: 104, abstract: 106, static: 108, final: 110, strictfp: 112, default: 114, synchronized: 116, native: 118, transient: 120, volatile: 122, throws: 150, implements: 160, interface: 166, enum: 176, instanceof: 238, open: 267, module: 269, requires: 274, transitive: 276, exports: 278, to: 280, opens: 282, uses: 284, provides: 286, with: 288, package: 292, import: 296, if: 308, else: 310, while: 314, for: 318, var: 325, assert: 332, switch: 336, case: 342, do: 346, break: 350, continue: 354, return: 358, throw: 364, try: 368, catch: 372, finally: 380 }, d = X.deserialize({
  version: 14,
  ...
  specialized: [{ term: 231, get: /* @__PURE__ */ $((Q) => R[Q] || -1, "get") }],
  tokenPrec: 7144
}), p = /* @__PURE__ */ l.define({
  name: "java",
  parser: /* @__PURE__ */ d.configure({
    props: [
      /* @__PURE__ */ Y.add({
        IfStatement: /* @__PURE__ */ i({ except: /^\s*({|else\b)/ }),
        TryStatement: /* @__PURE__ */ i({ except: /^\s*({|catch|finally)\b/ }),
        LabeledStatement: S,
        SwitchBlock: /* @__PURE__ */ $((Q) => {
          let P = Q.textAfter, a = /^\s*\}/.test(P), r = /^\s*(case|default)\b/.test(P);
          return Q.baseIndent + (a ? 0 : r ? 1 : 2) * Q.unit;
        }, "SwitchBlock"),
        Block: /* @__PURE__ */ o({ closing: "}" }),
        BlockComment: /* @__PURE__ */ $(() => null, "BlockComment"),
        Statement: /* @__PURE__ */ i({ except: /^{/ })
      }),
      /* @__PURE__ */ t.add({
        "Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody ConstructorBody InterfaceBody ArrayInitializer": Z,
        BlockComment(Q) {
