...
var P = (Q, e) => Y(Q, "name", { value: e, configurable: !0 });
import { ExternalTokenizer as s, ContextTracker as x, styleTags as w, tags as O, LRParser as d, LocalTokenGroup as k, snippetCompletion as X, syntaxTree as h, LRLanguage as f, indentNodeProp as u, continuedIndent as $, flatIndent as y, delimitedIndent as g, foldNodeProp as j, foldInside as U, LanguageSupport as G, ifNotIn as b, completeFromList as Z, IterMode as _, NodeWeakMap as q } from "../../../editor.js";
const E = 177, v = 179, C = 184, D = 12, z = 13, F = 17, B = 20, N = 25, I = 53, L = 95, A = 142, J = 144, M = 145, H = 148, K = 10, OO = 13, QO = 32, eO = 9, S = 47, aO = 41, tO = 125, iO = new s((Q, e) => {
  for (let n = 0, a = Q.next; (e.context && (a < 0 || a == K || a == OO || a == S && Q.peek(n + 1) == S) || a == aO || a == tO) && Q.acceptToken(E), !(a != QO && a != eO); )
    a = Q.peek(++n);
}, { contextual: !0 });
...
const nO = new x({
  start: !1,
  shift: /* @__PURE__ */ P((Q, e) => e == v ? Q : XO.has(e), "shift")
}), PO = w({
  ...
  "[ ]": O.squareBracket,
  "{ }": O.brace
}), oO = { __proto__: null, package: 10, import: 18, true: 380, false: 380, nil: 383, struct: 48, func: 68, interface: 78, chan: 94, map: 118, make: 157, new: 159, const: 204, type: 212, var: 224, if: 236, else: 238, switch: 242, case: 248, default: 250, for: 260, range: 266, go: 270, select: 274, return: 284, break: 288, continue: 290, goto: 292, fallthrough: 296, defer: 300 }, cO = d.deserialize({
  version: 14,
  ...
  tokenizers: [iO, 1, 2, new k("j~RQYZXz{^~^O$|~~aP!P!Qd~iO$}~~", 25, 181)],
  topRules: { SourceFile: [0, 3] },
  dynamicPrecedences: { 19: 1, 51: -1, 55: 2, 69: -1, 108: -1 },
  specialized: [{ term: 184, get: /* @__PURE__ */ P((Q) => oO[Q] || -1, "get") }],
  tokenPrec: 5451
}), rO = [
  /* @__PURE__ */ X("func ${name}(${params}) ${type} {\n	${}\n}", {
    label: "func",
    detail: "declaration",
    type: "keyword"
  }),
  /* @__PURE__ */ X("func (${receiver}) ${name}(${params}) ${type} {\n	${}\n}", {
    label: "func",
    detail: "method declaration",
    type: "keyword"
  }),
  /* @__PURE__ */ X("var ${name} = ${value}", {
    label: "var",
    detail: "declaration",
    type: "keyword"
  }),
  /* @__PURE__ */ X("type ${name} ${type}", {
    label: "type",
    detail: "declaration",
    type: "keyword"
  }),
  /* @__PURE__ */ X("const ${name} = ${value}", {
    label: "const",
    detail: "declaration",
    type: "keyword"
  }),
  ...
  /* @__PURE__ */ X("for ${init}; ${test}; ${update} {\n	${}\n}", {
    label: "for",
    detail: "loop",
    type: "keyword"
  }),
  /* @__PURE__ */ X("for ${i} := range ${value} {\n	${}\n}", {
    label: "for",
    detail: "range",
    type: "keyword"
  }),
  ...
  /* @__PURE__ */ X('import ${name} "${module}"\n${}', {
    label: "import",
    detail: "declaration",
    type: "keyword"
  })
], p = /* @__PURE__ */ new q(), W = /* @__PURE__ */ new Set([
  "SourceFile",
  "Block",
  "FunctionDecl",
  "MethodDecl",
...
function c(Q, e) {
  return (n, a) => {
    O: for (let t = n.node.firstChild, r = 0, i = null; ; ) {
      for (; !t; ) {
        if (!r)
          break O;
        r--, t = i.nextSibling, i = i.parent;
      }
      e && t.name == e || t.name == "SpecList" ? (r++, i = t, t = t.firstChild) : (t.name == "DefName" && a(t, Q), t = t.nextSibling);
    }
    return !0;
  };
}
P(c, "defIDs");
const lO = {
  FunctionDecl: /* @__PURE__ */ c("function"),
  VarDecl: /* @__PURE__ */ c("var", "VarSpec"),
  ConstDecl: /* @__PURE__ */ c("constant", "ConstSpec"),
  TypeDecl: /* @__PURE__ */ c("type", "TypeSpec"),
  ImportDecl: /* @__PURE__ */ c("constant", "ImportSpec"),
  Parameter: /* @__PURE__ */ c("var"),
  __proto__: null
};
function m(Q, e) {
  let n = p.get(e);
  ...
  let a = [], t = !0;
  function r(i, o) {
    let R = Q.sliceString(i.from, i.to);
    a.push({ label: R, type: o });
  }
  return P(r, "def"), e.cursor(_.IncludeAnonymous).iterate((i) => {
    if (t)
      t = !1;
    else if (i.name) {
      let o = lO[i.name];
      if (o && o(i, r) || W.has(i.name))
        return !1;
    } else if (i.to - i.from > 8192) {
      for (let o of m(Q, i.node))
        a.push(o);
      return !1;
    }
  }), p.set(e, a), a;
...
const T = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, V = [
  ...
  let e = h(Q.state).resolveInner(Q.pos, -1);
  if (V.indexOf(e.name) > -1)
    return null;
  let n = e.name == "VariableName" || e.to - e.from < 20 && T.test(Q.state.sliceDoc(e.from, e.to));
  if (!n && !Q.explicit)
    return null;
  let a = [];
  for (let t = e; t; t = t.parent)
    W.has(t.name) && (a = a.concat(m(Q.state.doc, t)));
  return {
    options: a,
    from: n ? e.from : Q.pos,
    validFor: T
  };
}, "localCompletionSource"), l = /* @__PURE__ */ f.define({
  name: "go",
  parser: /* @__PURE__ */ cO.configure({
    props: [
      /* @__PURE__ */ u.add({
        IfStatement: /* @__PURE__ */ $({ except: /^\s*({|else\b)/ }),
        LabeledStatement: y,
        "SwitchBlock SelectBlock": /* @__PURE__ */ P((Q) => {
          let e = Q.textAfter, n = /^\s*\}/.test(e), a = /^\s*(case|default)\b/.test(e);
          return Q.baseIndent + (n || a ? 0 : Q.unit);
        }, "SwitchBlock SelectBlock"),
        Block: /* @__PURE__ */ g({ closing: "}" }),
        BlockComment: /* @__PURE__ */ P(() => null, "BlockComment"),
        Statement: /* @__PURE__ */ $({ except: /^{/ })
      }),
      /* @__PURE__ */ j.add({
...
let SO = /* @__PURE__ */ P((Q) => ({ label: Q, type: "keyword" }), "kwCompletion");
const pO = /* @__PURE__ */ "interface struct chan map package go return break continue goto fallthrough else defer range true false nil".split(" ").map(SO);
function mO() {
  let Q = rO.concat(pO);
  return new G(l, [
    l.data.of({
      autocomplete: b(V, Z(Q))
    }),
    l.data.of({
      autocomplete: $O
    })
