...
var e = (T, Q) => i(T, "name", { value: Q, configurable: !0 });
import { LRLanguage as n, indentNodeProp as $, continuedIndent as y, foldNodeProp as P, foldInside as X, defineCSSCompletionSource as m, LanguageSupport as c, styleTags as f, tags as O, LRParser as s, ExternalTokenizer as l } from "../../../editor.js";
const p = 110, o = 1, W = 2, t = [
  9,
  10,
  11,
  12,
...
e(d, "isDigit");
const Z = /* @__PURE__ */ new l((T, Q) => {
  if (T.next == 40) {
    let a = T.peek(-1);
    (S(a) || d(a) || a == 95 || a == 45) && T.acceptToken(W, 1);
  }
}), w = /* @__PURE__ */ new l((T) => {
  if (t.indexOf(T.peek(-1)) > -1) {
    let { next: Q } = T;
    (S(Q) || Q == 95 || Q == 35 || Q == 46 || Q == 91 || Q == 58 || Q == 45) && T.acceptToken(p);
  }
}), z = /* @__PURE__ */ new l((T) => {
  if (t.indexOf(T.peek(-1)) < 0) {
    let { next: Q } = T;
    if (Q == 37 && (T.advance(), T.acceptToken(o)), S(Q)) {
      do
        T.advance();
      while (S(T.next));
      T.acceptToken(o);
  ...
  "[ ]": O.squareBracket,
  "{ }": O.brace
}), g = { __proto__: null, lang: 40, "nth-child": 40, "nth-last-child": 40, "nth-of-type": 40, "nth-last-of-type": 40, dir: 40, "host-context": 40, and: 244, or: 244, not: 74, only: 74, url: 86, "url-prefix": 86, domain: 86, regexp: 86, when: 117, selector: 142, from: 172, to: 174 }, u = { __proto__: null, "@import": 126, "@plugin": 126, "@media": 152, "@charset": 156, "@namespace": 160, "@keyframes": 166, "@supports": 178 }, U = /* @__PURE__ */ s.deserialize({
  version: 14,
  ...
  tokenizers: [w, z, Z, 0, 1, 2, 3, 4],
  topRules: { StyleSheet: [0, 5] },
  specialized: [{ term: 116, get: /* @__PURE__ */ e((T) => g[T] || -1, "get") }, { term: 23, get: /* @__PURE__ */ e((T) => u[T] || -1, "get") }],
  tokenPrec: 2180
}), r = /* @__PURE__ */ n.define({
  name: "less",
  parser: /* @__PURE__ */ U.configure({
    props: [
      /* @__PURE__ */ $.add({
...
}), R = /* @__PURE__ */ m((T) => T.name == "VariableName" || T.name == "AtKeyword");
function G() {
  return new c(r, r.data.of({ autocomplete: R }));
}
e(G, "less");
export {
  G as less,
  R as lessCompletionSource,
  r as lessLanguage
};
