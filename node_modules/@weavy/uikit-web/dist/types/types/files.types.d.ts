...
import { MetadataType, SortOrderType } from './lists.types';
...
export type FileActionType = "attach" | "create" | "delete-forever" | "edit" | "modify" | "rename" | "replace" | "restore" | "subscribe" | "trash" | "unsubscribe" | "upload" | "version";
...
export type FileMutationType = Mutation<FileType | BlobType, Error, MutateFileProps, FileMutationContextType | undefined>;
export type FileOpenEventType = CustomEvent<{
    fileId: number;
