...
export declare const MixinWeavyEvents: <TBase extends Constructor>(Base: TBase) => {
    new (...params: any[]): {
        "__#64@#eventHandlers": EventHandlerType[];
        "__#64@#eventParent": any;
        eventParent: any;
        "__#64@#eventChildren": Set<unknown>;
         ...
         */
        "__#64@#registerEventHandler"(events: string, selector: string | PlainObjectType | undefined | null, handler: () => void, originalHandler: () => void): void;
        /**
         ...
         */
        "__#64@#getEventHandler"(events: string, selector: string | object, handler: () => void, originalHandler?: () => void): ((...params: any[]) => any) | undefined;
        /**
         ...
         */
        "__#64@#unregisterEventHandler"(events: string, selector: string | object | undefined | null, handler: (() => void) | null | undefined, originalHandler: () => void): boolean;
        /**
         ...
         */
        "__#64@#triggerHandler"(eventName: string, data: any, ...additionalData: any[]): any;
        /**
         ...
         * @
         */
        "__#64@#getEventArguments"(eventArguments: any[]): {
            events: any;
            selector: any;
            handler: any;
        };
