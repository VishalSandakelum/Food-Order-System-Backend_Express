...
export declare function getIcon(name: string): {
    icon: iconNamesType;
    color?: string;
};
/**
...
export declare function getProvider(provider: FileProviderType | undefined): ProviderType | "";
export declare function getKind(name: string): FileKindType;
export declare function handleSelectFilename(e: Event): void;
