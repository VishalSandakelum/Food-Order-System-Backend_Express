...
export declare function getFileMutationsByConflictOrError(mutationStates?: MutationState<BlobType | FileType, Error, unknown, FileMutationContextType>[]): MutationState<FileType | BlobType, Error, unknown, FileMutationContextType>[];
